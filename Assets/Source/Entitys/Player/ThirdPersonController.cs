...
[AddComponentMenu("PersonController/ ThirdPersonController")]
...
public class ThirdPersonController : MonoBehaviour 
{
    ...
    void OnDrawGizmos()
    {
        ...
        Custom.Utility.NGizmos.DrawWireCube(transform.position + new Vector3(0, 1, 0), new Vector3(0.8f, 2, 0.8f), Color.white);
    }
#endif
}
